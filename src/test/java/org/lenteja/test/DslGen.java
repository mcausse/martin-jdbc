...
/// **
// * <pre>
// begin() select() from<A>(A) {join<B>(B) on<A,B>()} {where()} [groupBy()
// [having()]] [orderBy()]
// * </pre>
// *
// * L'algoritme pinta recursiu. Per cada producció "n" (token), essent el
// primer
// * token sempre "begin()":
// *
// * <pre>
...
//
// Prod select = new Prod("select", "select(Column<?,?>... columns)",
// "select(Table<?>...tables)", "selectStar()");
// Prod from = new Prod("from", "from(Table<?> table)", "from(Select
// selectQuery)");
// Prod join = new Prod("join", "join(Table<?> table)", "join(Select
// selectQuery, String alias)");
...
// Prod END = new Prod("execute", "<E>Executor<E> getExecutor(DataAccesFacade
// facade, Mapable<E> mapable)");
//
// // Prod update = new Prod("update", "update(Table<?> table)");
// // Prod set = new Prod("set", "set(IQueryObject... restrictions)");
// // Prod updateWhere = new Prod("where2", "where(IQueryObject...
// restrictions)");
//
...
// // "
// // + "from dogs dogs_ join persons persons_ on
// dogs_.id_jefe=persons_.id_person
// // "
...
// }
//
// public String toString(Set<Prod> explored, Set<String> generatedClassNames,
// Set<String> methodDefs) {
//
// StringBuilder r = new StringBuilder();
...
//
// if (nexts.size() >= 2) {
// r.append("public interface " + getNextsAsClassName() + " extends " +
// getNextsInterfaceNames() + "{}\n");
...
// }
//
// public interface Join_Where_GroupBy_OrderBy_Execute extends Join, Where,
// GroupBy, OrderBy, Execute {
// }
//
...
// }
//
// public interface Where_GroupBy_OrderBy_Execute extends Where, GroupBy,
// OrderBy, Execute {
// }
//
...
// public <E> Executor<E> getExecutor(DataAccesFacade facade, Mapable<E>
// mapable);
// }
//
// public class Select
// implements OrderBy, GroupBy, Execute, Where_GroupBy_OrderBy_Execute,
// OrderBy_Execute, SSelect, Join, From,
// Having, Having_OrderBy_Execute, Join_Where_GroupBy_OrderBy_Execute,
// GroupBy_OrderBy_Execute, Where, On {
//
