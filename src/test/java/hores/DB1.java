...
//
// List<RangedChunk<Long, String>> results = cm.loadRangedChunksFor(crs, 5L,
// 10L);
...
// // }
//
// static class ChunkManager<K extends Comparable<K> & Serializable, V extends
// Serializable> {
//
...
//
// LOG.info("*** " + numChunks + " chunks, index=" + indexBytes + "b, data=" +
// dataBytes + "b)");
// }
//
...
// }
//
// public static class RangedChunk<K extends Comparable<K> & Serializable, V
...
// }
//
// public RangedChunk<K, V> loadRangedChunkFor(ChunkRanges<K> crs, K key) throws
// IOException {
...
// }
//
// public List<RangedChunk<K, V>> loadRangedChunksFor(ChunkRanges<K> crs, K
// start, K end) throws IOException {
...
//
// SortedSet<ChunkRange<K>> ranges = crs.ranges.subSet(minCr, true, maxCr,
// true);
//
...
// }
//
// public void storeRangedChunk(ChunkRanges<K> crs, RangedChunk<K, V> rc) throws
// IOException {
//
// try {
...
// }
//
// protected RangedChunk<K, V> splitChunk(ChunkRanges<K> crs, ChunkRange<K>
// chunkRange, Chunk<K, V> chunk) {
...
// @Override
// public String toString() {
// return "ChunkRanges(num=" + ranges.size() + ") [chunkMaxSizeInBytes=" +
// chunkMaxSizeInBytes + ", ranges="
// + ranges + "]";
// }
//
// }
//
// static class ChunkRange<K extends Comparable<K> & Serializable> implements
// Comparable<ChunkRange<K>>, Serializable {
//
...
// }
//
// static class Chunk<K extends Comparable<K> & Serializable, V extends
// Serializable> {
//
// Long numChunk;
...
// }
//
// public void store(RandomAccessFile raf, long chunkSize) throws
// ChunkSizeException, IOException {
