...
public class TableGenerator {
    ...
    public static class TableMeta {
        ...
        public TableMeta(String catalogName, String tableName, String entityName) {
            super();
        ...
        public String toString() {
            ...
            s.append("public class " + getEntityName() + "Table extends Table<" + getEntityName() + "> {\n");

            for (ColumnMeta c : columns) {
                s.append("\tpublic final Column<" + getEntityName() + ", " + c.getColumnClassName() + "> "
                        + c.getPropertyName() + " = add" + (c.isPk ? "Pk" : "") + "Column(" + c.getColumnClassName()
                        + ".class, \"" + c.getPropertyName() + "\", \"" + c.getColumnName() + "\");\n");
            }

            s.append("\tpublic " + getEntityName() + "Table() {\n");
            s.append("\t\tsuper(\"" + getTableName() + "\");\n");
            for (ColumnMeta c : columns) {
                if (c.isPk()) {
    ...
    public static class MetaTableExtractor implements ResultSetExtractor<TableMeta> {
        ...
        public TableMeta extract(ResultSet rs) throws SQLException {
            ...
            TableMeta r = new TableMeta(rsmd.getCatalogName(1), rsmd.getTableName(1), entityName);
